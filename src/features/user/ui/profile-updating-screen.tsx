...
export const ProfileUpdatingScreen = (props: ProfileUpdatingScreenProps) => {
  ...
  const getUsernameError = () => {
    ...
    if (state.error == UserError.usernameTaken) return "This username is taken";
  };
  ...
  return (
    <div className={classes.wrapper} data-testid="profile-updating-screen">
      ...
      {!props.registering && <BackButton className={classes.logoutButton} />}
      <div className={classes.layout}>
        <ProfilePhotoPicker
          defaultSrc={defaultSrc}
          src={src ?? ""}
          onPhotoPicker={photoPicked}
