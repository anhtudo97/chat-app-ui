...
type ProfilePhotoPickerProps = {
  defaultSrc: string;
  src?: string;
  onPhotoPicker: (photo: File) => void;
  onPhotoRemoved: () => void;
} & ProfilePhotoPickerStyle;

const useStyles = makeStyles<
  Theme,
  ProfilePhotoPickerStyle & { isDragActive: boolean }
>((_) => {
...
export const ProfilePhotoPicker: React.FC<ProfilePhotoPickerProps> = ({
  ...
  const classes = useStyles({ size, isDragActive });

  const menuItems = [
    { icon: "edit", label: "New profile photo", onClick: confirmRemoval },
  ];
  ...
  return (
    <div className={classes.wrapper} data-testid="profile-photo-picker">
