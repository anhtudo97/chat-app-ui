...
test("Clicking the login button should dispatch the appropriate action", async () => {
  //arrange
  const mockStore = MockStore(initialState);
...
test("If the state is loading, should display a spinner instead of the button", () => {
  // arrange
