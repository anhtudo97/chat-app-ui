...
export const FriendshipButton = () => {
  ...
  const block =
    state.friendship?.status === FriendshipStatus.BLOCKING ||
  ...
  const onRequestSentTapped = useCallback(
  ...
  const onRequestReceivedTapped = useCallback(
    (e: React.MouseEvent<HTMLElement>) => {
  ...
  const askForUnfriendConfirmation = useCallback(
    (e: React.MouseEvent<HTMLElement>) => {
  ...
  return (
    <div className={buttonClasses.wrapper} data-testid="friendship-button">
      ...
      >
        ...
        <MenuItem onClick={declineFR} data-testid="accept request">
      ...
      <GenericMenu
        ...
        onClose={onClose}
      >
        <MenuItem onClick={cancelFR} data-testid="accept request">
          <Icon className={classes.clearIcon}>clear</Icon>
          Cancel
        </MenuItem>
      </GenericMenu>
